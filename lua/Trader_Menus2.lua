...
if list_id == 1 then
  sell_list_short = {"cap_helmet", "wooden_shield", "fur_cloak", "stone_ring", "leather_armor", "elven_tunic", "boot_cleat", "small_dagger"}
-- for testing
...
elseif list_id == 2 then
  sell_list_short = {"chain_helmet", "light_helmet", "leather_gloves", "steel_ring", "leather_armor", "scale_armor", "leather_boots", "steel_spear"}
...
elseif list_id == 3 then
  sell_list_short = {"steel_helmet", "iron_shield", "steel_ring", "chain_armor", "scale_armor", "steel_arrows", "steel_axe", "steel_blade"}
...
elseif list_id == 4 then
  sell_list_short = {"crested_helmet", "iron_shield", "steel_greaves", "gold_ring", "breastplate", "steel_arrows", "silver_dagger", "steel_blade"}
...
elseif list_id == 5 then
  sell_list_short = {"bascinet_helmet", "door_shield", "elf_cloak", "gold_ring", "chain_armor", "silver_dagger", "steel_axe", "steel_spear"}
--  sell_list_short = {"bascinet_helmet", "door_shield", "elf_cloak", "gold_ring", "breastplate", "chain_armor", "steel_arrows", "silver_dagger", "steel_blade", "steel_axe", "steel_spear"}
  ...
  sell_list_short = {"fur_hat", "cap_helmet", "wooden_shield", "fur_cloak", "stone_ring", "leather_armor"}
end
local pool_value = 0
local sell_value = 0
local dialog = {
